...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Collection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Saas.Entities.CollectionSecret", b =>
                {
                    ...
                    b.HasKey("CollectionId", "SecretId");

                    b.HasIndex("SecretId");

                    b.ToTable("CollectionSecrets");
                });

            modelBuilder.Entity("Saas.Entities.OneTimeShare", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Saas.Entities.CollectionSecret", b =>
                {
                    b.HasOne("Entities.Collection", "Collection")
                        .WithMany("CollectionSecrets")
            ...
            modelBuilder.Entity("Entities.Collection", b =>
                {
                    b.Navigation("CollectionSecrets");
                });
            ...
            modelBuilder.Entity("Entities.Organization", b =>
                {
                    ...
                    b.Navigation("SecretCollections");
